...
public class XPath {
	 ...
	 */
	public static List<Node> selectNodes(String expr, Node doc, Map<String, String> ns) throws HttpException {
	 ...
	 * @throws HttpException
	 */
	public static String selectText(String expr, Node doc, Map<String, String> ns) throws HttpException {
		if (doc == null || expr == null)
			return null;
	 ...
	 * @throws HttpException
	 */
	public static Node selectNode(String expr, Node doc, Map<String, String> ns) throws HttpException {
		if (doc == null || expr == null)
			return null;
